      ...
      <div id="letter-section"
        ...
        <div class="max-w-xs sm:max-w-md mx-auto bg-gradient-to-br from-white via-pink-50/50 to-purple-50 border-4 border-pink-300 p-6 sm:p-8 rounded-3xl shadow-xl text-left relative overflow-hidden space-y-4">
          ...
          <div class="flex items-center justify-between border-b-2 border-pink-100 pb-3">
            <span class="font-cute text-pink-500 font-bold text-xs sm:text-sm">For: Alia Jennifer Kim Ritzky ✨</span>
          ...
          <div class="space-y-3 text-xs sm:text-sm text-slate-600 leading-relaxed font-sans">
            ...
            <p>
              Mengingat awal pertama kita ketemu gara-gara kamu nanya soal program Bangkit—dari yang dulu masih belajar awal banget di dunia IT, sampai sekarang bisa se-jago ini dan bahkan berhasil jadi <b>lulusan terbaik di program Asah</b>... Jujur, progress kamu luar biasa banget dan aku beneran bangga sama kamu! 🌟
            </p>
            <p>
              Kamu itu sosok yang gigih, kuat, otentik, baik hati, dan punya energi positif yang selalu berhasil bikin orang-orang di sekitarmu merasa nyaman. Melihat perjuangan kamu sejauh ini bikin aku makin yakin, di masa depan nanti kamu pasti bisa meraih semua mimpi-mimpi besar kamu. Jangan pernah ragu sama kemampuan diri kamu sendiri ya!
            </p>
            <p>
              Semoga di level 22 ini, semua impianmu dipermudah, makin banyak kebahagiaan yang datang, sehat selalu, dan tentunya... bisa makan dimsum enak sepuasnya tanpa ragu! 🥟✨
            </p>
            <p>
          ...
          <div class="border-t-2 border-pink-100 pt-4 text-right">
            ...
            <span class="font-cute text-slate-400 text-xs">Sani</span>
          </div>
